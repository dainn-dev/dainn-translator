"""Gemini translator for translation using Google Gemini API."""
import requests
import logging
...
class GeminiTranslator:
    ...
    def __init__(self, api_url: str = "https://generativelanguage.googleapis.com/v1", api_key: str = "", model_name: str = "gemini-pro"):
        """
        Initialize Gemini translator.
        
        Args:
            api_url: Base URL for Gemini API (default: https://generativelanguage.googleapis.com/v1)
        ...
        logger.info(f"Initialized Gemini translator with API URL: {self.api_url}, Model: {self.model_name}")
    ...
    def translate(self, text: str, source_language: str, target_language: str) -> str:
        ...
        try:
            ...
            endpoints_to_try = [
                ...
                f"{self.api_url}/models/{self.model_name}:generateContent",
            ]
            ...
            for endpoint in unique_endpoints:
                try:
                    # For Gemini, API key can be in URL or header
                    headers = {
                        "Content-Type": "application/json"
                    }
                    
                    # If API key is not in URL, add it to header
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            endpoint = f"{self.api_url}/models/{self.model_name}:generateContent"
            ...
            logger.debug(f"Gemini connection test failed: {str(e)}")
            return False
