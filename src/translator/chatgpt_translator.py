"""ChatGPT translator for translation using OpenAI-compatible API."""
import requests
import logging
...
class ChatGPTTranslator:
    """Translator using ChatGPT/OpenAI-compatible API."""
    
    def __init__(self, api_url: str = "https://api.openai.com/v1", api_key: str = "", model_name: str = "gpt-3.5-turbo"):
        """
        Initialize ChatGPT translator.
        
        Args:
            api_url: Base URL for OpenAI-compatible API (default: https://api.openai.com/v1)
        ...
        logger.info(f"Initialized ChatGPT translator with API URL: {self.api_url}, Model: {self.model_name}")
    ...
    def translate(self, text: str, source_language: str, target_language: str) -> str:
        ...
        if not self.api_key:
            logger.error("ChatGPT API key is not set")
            return text
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.debug(f"ChatGPT connection test failed: {str(e)}")
            return False
